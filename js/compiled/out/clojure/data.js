...
return cljs.core.reduce.call(null,(function (result,p__54220){
var vec__54221 = p__54220;
var k = cljs.core.nth.call(null,vec__54221,(0),null);
var v = cljs.core.nth.call(null,vec__54221,(1),null);
...
var vec__54227 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__54227,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__54227,(1),null);
var ab = cljs.core.nth.call(null,vec__54227,(2),null);
...
var args54230 = [];
var len__25865__auto___54233 = arguments.length;
var i__25866__auto___54234 = (0);
while(true){
if((i__25866__auto___54234 < len__25865__auto___54233)){
args54230.push((arguments[i__25866__auto___54234]));

var G__54235 = (i__25866__auto___54234 + (1));
i__25866__auto___54234 = G__54235;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54230.length)].join('')));
...
return (function (){var G__54240 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__54240) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1484800047437