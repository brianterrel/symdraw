...
var G__44237 = o;
(G__44237[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__44239__i < G__44239__a.length) {G__44239__a[G__44239__i] = arguments[G__44239__i + 0]; ++G__44239__i;}
  args = new cljs.core.IndexedSeq(G__44239__a,0);
} 
...
var G__44246 = jsprops;
(G__44246["defaultValue"] = value);

(G__44246["onChange"] = ((function (G__44246,v,value,on_change){
return (function (p1__44243_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__44243_SHARP_);
});})(G__44246,v,value,on_change))
);

(G__44246["ref"] = ((function (G__44246,v,value,on_change){
return (function (p1__44244_SHARP_){
return (this$["cljsInputElement"] = p1__44244_SHARP_);
});})(G__44246,v,value,on_change))
);
...
var vec__44253 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__44253,(0),null);
var id = cljs.core.nth.call(null,vec__44253,(1),null);
var class$ = cljs.core.nth.call(null,vec__44253,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___44258 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___44258 == null)){
} else {
var key_44259 = temp__4661__auto___44258;
(jsprops["key"] = key_44259);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__44261 = (new reagent.impl.template.NativeWrapper());
(G__44261["name"] = c);
...
var len__25865__auto___44267 = arguments.length;
var i__25866__auto___44268 = (0);
while(true){
if((i__25866__auto___44268 < len__25865__auto___44267)){
args__25872__auto__.push((arguments[i__25866__auto___44268]));

var G__44269 = (i__25866__auto___44268 + (1));
i__25866__auto___44268 = G__44269;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq44265){
var G__44266 = cljs.core.first.call(null,seq44265);
var seq44265__$1 = cljs.core.next.call(null,seq44265);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__44266,seq44265__$1);
});
...
break;
default:
var G__44273 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__44273;
continue;
...
var n__25705__auto___44276 = a.length;
var i_44277 = (0);
while(true){
if((i_44277 < n__25705__auto___44276)){
(a[i_44277] = reagent.impl.template.as_element.call(null,(a[i_44277])));
...
var a = cljs.core.into_array.call(null,s);
var n__25705__auto___44279 = a.length;
var i_44280 = (0);
while(true){
if((i_44280 < n__25705__auto___44279)){
var val_44281 = (a[i_44280]);
if((cljs.core.vector_QMARK_.call(null,val_44281)) && ((reagent.impl.template.key_from_vec.call(null,val_44281) == null))){
(o["no-key"] = true);
} else {
}

(a[i_44280] = reagent.impl.template.as_element.call(null,val_44281));
...
var ctx = ({});
var vec__44286 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__44286,(0),null);
var derefed = cljs.core.nth.call(null,vec__44286,(1),null);
...
var G__44290 = (cljs.core.count.call(null,argv) - first_child);
switch (G__44290) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__44290){
...
//# sourceMappingURL=template.js.map?rel=1484800030677