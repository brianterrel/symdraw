...
var map__55217 = top_item;
var map__55217__$1 = ((((!((map__55217 == null)))?((((map__55217.cljs$lang$protocol_mask$partition0$ & (64))) || (map__55217.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55217):map__55217);
...
}catch (e55216){var _e = e55216;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___55219 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___55219)){
var seen_errors_55220 = temp__4655__auto___55219;
if(cljs.core.truth_(seen_errors_55220.has(self))){
} else {
seen_errors_55220.add(self);

var temp__4657__auto___55221 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___55221)){
var sense_55222 = temp__4657__auto___55221;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_55222)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1484800050074