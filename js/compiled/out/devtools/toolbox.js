...
var args54862 = [];
var len__25865__auto___54868 = arguments.length;
var i__25866__auto___54869 = (0);
while(true){
if((i__25866__auto___54869 < len__25865__auto___54868)){
args54862.push((arguments[i__25866__auto___54869]));

var G__54870 = (i__25866__auto___54869 + (1));
i__25866__auto___54869 = G__54870;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54862.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox54865 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox54865 = (function (obj,header,style,tag,meta54866){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox54865.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_54867,meta54866__$1){
var self__ = this;
var _54867__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox54865(self__.obj,self__.header,self__.style,self__.tag,meta54866__$1));
});

devtools.toolbox.t_devtools$toolbox54865.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_54867){
var self__ = this;
var _54867__$1 = this;
return self__.meta54866;
});

devtools.toolbox.t_devtools$toolbox54865.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox54865.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox54865.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox54865.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox54865.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta54866","meta54866",-1450334474,null)], null);
});

devtools.toolbox.t_devtools$toolbox54865.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox54865.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox54865";

devtools.toolbox.t_devtools$toolbox54865.cljs$lang$ctorPrWriter = (function (this__25396__auto__,writer__25397__auto__,opt__25398__auto__){
return cljs.core._write.call(null,writer__25397__auto__,"devtools.toolbox/t_devtools$toolbox54865");
});

devtools.toolbox.__GT_t_devtools$toolbox54865 = (function devtools$toolbox$__GT_t_devtools$toolbox54865(obj__$1,header__$1,style__$1,tag__$1,meta54866){
return (new devtools.toolbox.t_devtools$toolbox54865(obj__$1,header__$1,style__$1,tag__$1,meta54866));
});

}

return (new devtools.toolbox.t_devtools$toolbox54865(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1484800049307