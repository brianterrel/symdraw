...
var o__30447__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__30459__auto__ = temp__4657__auto__;
return goog.object.get(o__30459__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__30447__auto__,"js_reserved_QMARK_").call(o__30447__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__30447__auto__ = f;
return goog.object.get(o__30447__auto__,"toString").call(o__30447__auto__);
}catch (e54294){var _ = e54294;
return "";
}});
...
try{var o__30447__auto___54297 = t;
goog.object.get(o__30447__auto___54297,"cljs$lang$ctorPrWriter").call(o__30447__auto___54297,t,writer);
}catch (e54296){var __54298 = e54296;
}
...
var char_code = (function (){var o__30447__auto__ = (new String(char$));
return goog.object.get(o__30447__auto__,"charCodeAt").call(o__30447__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30447__auto__ = String;
return goog.object.get(o__30447__auto__,"fromCharCode").call(o__30447__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__54300 = num_code;
switch (G__54300) {
case (1):
return (185);
...
var o__30447__auto__ = String;
return goog.object.get(o__30447__auto__,"fromCharCode").call(o__30447__auto__,superscript_code);
});
/**
...
}catch (e54306){var e__30472__auto__ = e54306;
return false;
}})())){
...
var vec__54307 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__54307,(0),null);
...
var temp__4657__auto____$1 = goog.object.get(o__30460__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__30459__auto__ = temp__4657__auto____$1;
return goog.object.get(o__30459__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__25865__auto___54316 = arguments.length;
var i__25866__auto___54317 = (0);
while(true){
if((i__25866__auto___54317 < len__25865__auto___54316)){
args__25872__auto__.push((arguments[i__25866__auto___54317]));

var G__54318 = (i__25866__auto___54317 + (1));
i__25866__auto___54317 = G__54318;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__54312){
var vec__54313 = p__54312;
var ns_detector = cljs.core.nth.call(null,vec__54313,(0),null);
...
var G__54319 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__54320 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__54319;
remaining_tokens = G__54320;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq54310){
var G__54311 = cljs.core.first.call(null,seq54310);
var seq54310__$1 = cljs.core.next.call(null,seq54310);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__54311,seq54310__$1);
});
...
break;
default:
var o__30447__auto__ = window;
return goog.object.get(o__30447__auto__,"parseInt").call(o__30447__auto__,arity,(10));
...
var vec__54328 = cljs.core.split_with.call(null,(function (p1__54324_SHARP_){
return cljs.core.not_EQ_.call(null,p1__54324_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__54328,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__54328,(1),null);
...
var vec__54334 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__54334,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__54334,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__54337 = cljs.core.rest.call(null,remaining_tokens);
var G__54338 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__54337;
name_tokens = G__54338;
continue;
} else {
...
var args54339 = [];
var len__25865__auto___54351 = arguments.length;
var i__25866__auto___54352 = (0);
while(true){
if((i__25866__auto___54352 < len__25865__auto___54351)){
args54339.push((arguments[i__25866__auto___54352]));

var G__54353 = (i__25866__auto___54352 + (1));
i__25866__auto___54352 = G__54353;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54339.length)].join('')));
...
var vec__54342 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__54342,(0),null);
var arity = cljs.core.nth.call(null,vec__54342,(1),null);
var vec__54345 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__54345,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__54345,(1),null);
var vec__54348 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__54348,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__54348,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__54348,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__54348,(3),null);
...
var args54355 = [];
var len__25865__auto___54361 = arguments.length;
var i__25866__auto___54362 = (0);
while(true){
if((i__25866__auto___54362 < len__25865__auto___54361)){
args54355.push((arguments[i__25866__auto___54362]));

var G__54363 = (i__25866__auto___54362 + (1));
i__25866__auto___54362 = G__54363;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args54355.length)].join('')));
...
var vec__54358 = result;
var munged_ns = cljs.core.nth.call(null,vec__54358,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__54358,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__54358,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__54358,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__54358,(4),null);
var arity = cljs.core.nth.call(null,vec__54358,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__54371 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__54371,(0),null);
var args = cljs.core.nth.call(null,vec__54371,(1),null);
var vec__54374 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__54374,(0),null);
var name = cljs.core.nth.call(null,vec__54374,(1),null);
...
var G__54377 = (arity + (1));
var G__54378 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__54379){
var vec__54383 = p__54379;
var arity = cljs.core.nth.call(null,vec__54383,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__54383,(1),null);
...
return (function (p1__54386_SHARP_){
return cljs.core.get.call(null,arities,p1__54386_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__54387_SHARP_){
return cljs.core.drop.call(null,(2),p1__54387_SHARP_);
...
var args__25872__auto__ = [];
var len__25865__auto___54394 = arguments.length;
var i__25866__auto___54395 = (0);
while(true){
if((i__25866__auto___54395 < len__25865__auto___54394)){
args__25872__auto__.push((arguments[i__25866__auto___54395]));

var G__54396 = (i__25866__auto___54395 + (1));
i__25866__auto___54395 = G__54396;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__54390){
var vec__54391 = p__54390;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__54391,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq54388){
var G__54389 = cljs.core.first.call(null,seq54388);
var seq54388__$1 = cljs.core.next.call(null,seq54388);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__54389,seq54388__$1);
});
...
var G__54398 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__54398) {
...
var map__54405 = options;
var map__54405__$1 = ((((!((map__54405 == null)))?((((map__54405.cljs$lang$protocol_mask$partition0$ & (64))) || (map__54405.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__54405):map__54405);
var include_ns_QMARK_ = cljs.core.get.call(null,map__54405__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__54405__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__54405__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__54405__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__54406 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__54406,(0),null);
var fn_name = cljs.core.nth.call(null,vec__54406,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__54406,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__54406,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__54406,(4),null);
var arity = cljs.core.nth.call(null,vec__54406,(5),null);
...
var o__30447__auto__ = f;
return goog.object.get(o__30447__auto__,"getBasis").call(o__30447__auto__);
});
/**
...
}catch (e54411){var e__30472__auto__ = e54411;
...
var G__54412 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__54413 = cljs.core.rest.call(null,path);
obj = G__54412;
path = G__54413;
continue;
} else {
...
return (function (accum,p__54418){
var vec__54419 = p__54418;
var bit = cljs.core.nth.call(null,vec__54419,(0),null);
var protocol = cljs.core.nth.call(null,vec__54419,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__54422){
var vec__54426 = p__54422;
var ns = cljs.core.nth.call(null,vec__54426,(0),null);
var name = cljs.core.nth.call(null,vec__54426,(1),null);
var selector = cljs.core.nth.call(null,vec__54426,(2),null);
...
return (function (p__54434){
var vec__54435 = p__54434;
var munged_name = cljs.core.nth.call(null,vec__54435,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__54435,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__54435,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__54429_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__54429_SHARP_));
});})(name,sorted_matches,vec__54435,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1484800048024